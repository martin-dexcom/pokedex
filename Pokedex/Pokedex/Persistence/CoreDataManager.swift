...
protocol CoreDataCrudProtocol {
  ...
  func savePokemonInPokedex(mockEntity: MockDataSource)
  // func savePokemonInPokedex(withEntity: )
  func deletePokemonInPokedex(withId id: Int)
  // func deletePokemonInPokedex(withId: Int)
...
class CoreDataManager: CoreDataCrudProtocol {
  ...
  func savePokemonInPokedex(mockEntity: MockDataSource) {
    ...
    pokemon.setValue(MockDataSource.pikachu.id, forKeyPath: "id")
    pokemon.setValue(MockDataSource.pikachu.sprites.frontDefault, forKey: "image")
    pokemon.setValue(MockDataSource.pikachu.name, forKey: "name")
    pokemon.setValue(MockDataSource.pikachu.stats.first?.baseStat ?? 0, forKey: "stat")
    pokemon.setValue(MockDataSource.pikachu.types.first?.type.name ?? "no type", forKey: "type")
